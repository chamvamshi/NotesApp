...
public class NotesDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database) {
        String query = "CREATE TABLE " + DB_TABLE +
                "(" + NotesDatabase.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,  " +
                NotesDatabase.COLUMN_TITLE + " TEXT, " +
                NotesDatabase.COLUMN_DETAILS + " TEXT, " +
                NotesDatabase.COLUMN_DATE + " TEXT, " +
                NotesDatabase.COLUMN_TIME + " TEXT " + ")";
    ...
    public void onUpgrade(SQLiteDatabase db, int i, int i1) {
        if (i > i1)
            return;
        db.execSQL("DROP TABLE IF EXISTS " + NotesDatabase.DB_NAME);
    ...
    public long AddNote(NotesModel notesModel) {
        ...
        long ID = db.insert(NotesDatabase.DB_TABLE, null, contentValues);
    ...
    public NotesModel getNotes(int id) {
        ...
        Cursor cursor = db.query(NotesDatabase.DB_TABLE, query, COLUMN_ID + " =? ", new String[]{String.valueOf(id)}, null, null, null, null);
    ...
    void deleteNote(int id) {
        SQLiteDatabase db = this.getReadableDatabase();
        db.delete(NotesDatabase.DB_TABLE, COLUMN_ID + " =? ", new String[]{String.valueOf(id)});
        db.close();
    }
}
